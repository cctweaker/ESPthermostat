...
<a href="https://3dstar.ro/proiecte/espthermostat">ESPthermostat</a> -
<a href="https://github.com/cctweaker/ESPthermostat">GitHub</a>
</b><br><br>
%s v%0.2f
<br><br>
</body>
...
<form action="/" method="POST"><input type="submit" value="Main menu"></form>
)=====";

const char form_buttons[] PROGMEM = R"=====(
<input type="submit" value="Submit"><br><br><input type="submit" name="save" value="Save config"></form>
<br><form action="/" method="POST"><input type="submit" value="Back"></form><br>
)=====";
...
<form action="%s" method="POST"%s><input type="submit" value="%s"></form><br>
)=====";

const char menu_entry_scan_wifi[] PROGMEM = R"=====(
<form method="POST"><input type="submit" name="scan" value="Scan WiFi"></form><br>
)=====";

const char menu_entry_reload_page[] PROGMEM = R"=====(
<form method="POST"><input type="submit" value="Reload page"></form><br>
)=====";
...
const char menu_entry_thermostat[] PROGMEM = R"=====(
Thermostat
)=====";
...
const char txt_mqtt_tele[] PROGMEM = R"=====(
TELE subtopic
)=====";
...
<br><br><form action='/' method="POST"><input type='submit' value='Back'></form>
)=====";

const char td_temp_c[] PROGMEM = R"=====(
<td>Sensor %d</td><td>%0.2f°C</td>
)=====";